    ...
    <div class="swiper-container" id="top">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="slide-inner" style="background-image:url(template/assets/images/slide-01.jpg)">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-8">
            ...
            <div class="swiper-slide">
                <div class="slide-inner" style="background-image:url(template/assets/images/slide-02.jpg)">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="header-text">
            ...
            <div class="swiper-slide">
                <div class="slide-inner" style="background-image:url(template/assets/images/slide-03.jpg)">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="header-text">
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="left-image">
                        <img src="{{ asset('template/assets/images/calculator-image.png') }}" alt="">
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="section-heading">
                    ...
                    <div class="owl-testimonials owl-carousel" style="position: relative; z-index: 5;">
                        <div class="item">
                            ...
                            <div class="right-image">
                                <img src="{{ asset('template/assets/images/testimonials-01.jpg') }}" alt="">
                            </div>
                        </div>
                        <div class="item">
                            <i class="fa fa-quote-left"></i>
